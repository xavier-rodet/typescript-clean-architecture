...
var TopicRepository = /** @class */ (function () {
    ...
    TopicRepository.prototype.insert = function (topic) {
        return __awaiter(this, void 0, void 0, function () {
            var rawTopic, error;
            return __generator(this, function (_a) {
                try {
                    rawTopic = topic_mapper_1.TopicMapper.fromDomain(topic);
                    this.knex(this.table).insert(rawTopic);
                }
                catch (e) {
                    error = utils_1.ErrorUtil.getError(e);
                    throw new errors_1.RepositoryError(error.message);
                }
                return [2 /*return*/];
            });
        });
