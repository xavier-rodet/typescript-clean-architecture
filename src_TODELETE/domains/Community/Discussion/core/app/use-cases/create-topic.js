...
var CreateTopic = /** @class */ (function () {
    ...
    CreateTopic.prototype.execute = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var topic;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.authorization.hasAtLeastRole(constants_1.ERole.PLAYER)) {
                            throw new errors_1.AuthorizationError();
                        }
                        topic = new entities_1.Topic({
                            authorId: this.authorization.getAuthUser().id,
                            title: input.title
                        });
                        return [4 /*yield*/, this.topicRepository.insert(topic)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, { topic: topic }];
                }
            });
        });
    };
